...
export default function ResultPanel({ isLoading, error, image, sketchData, prompt }: Props) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-[#333333] rounded-xl min-h-64 bg-[#0a0a0a] p-4">
      {isLoading && (
      ...
      {!isLoading && !error && !image && <p className="text-gray-600 text-sm">结果将在此显示</p>}
